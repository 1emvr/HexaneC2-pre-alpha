...
namespace Xtea {
    ...
    FUNCTION VOID       InitCipher (CIPHER *c, const byte *m_key);
    FUNCTION VOID       XteaEncrypt(CIPHER *c, byte *dst, byte *src);
    FUNCTION VOID       XteaDecrypt(CIPHER *c, byte *dst, byte *src);
