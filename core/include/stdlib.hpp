...
FUNCTION wchar_t x_toLowerW(const wchar_t c);
FUNCTION char x_toLowerA(const char c);
FUNCTION wchar_t *x_wcsToLower(wchar_t *const dst, const wchar_t *const src);
FUNCTION char *x_mbsToLower(char *const dst, const char *const src);
...
FUNCTION int x_endswith_a (const char *string, const char *const end);
FUNCTION int x_endswith_w (const wchar_t *string, const wchar_t *const end);
